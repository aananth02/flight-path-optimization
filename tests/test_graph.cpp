...
TEST_CASE("Edge Weights and Labels Small", "[graph]")
{
    ...
    vector<float> weights = {distance(-6.081689834590001, 145.391998291, -5.826789855957031, 144.29600524902344),
                             ...
                             distance(-5.826789855957031, 144.29600524902344, -6.569803, 146.725977),
                             distance(-6.569803, 146.725977, -5.20707988739, 145.789001465),
                             distance(-5.20707988739, 145.789001465, -3.58383011818, 143.669006348),
                             distance(-9.443380355834961, 147.22000122070312, -5.826789855957031, 144.29600524902344),
                             distance(-9.443380355834961, 147.22000122070312, -6.569803, 146.725977)};
    vector<string> labels = {"CG", "CG", "CG", "CG", "CG", "CG", "CG", "CG", "CG"};
